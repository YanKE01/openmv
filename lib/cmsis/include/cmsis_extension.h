...
{
  uint32_t result = (uint32_t) abs((int32_t) ((op1 & 0xFF) - (op2 & 0xFF)));
  result += (uint32_t) abs((int32_t) (((op1 >> 8) & 0xFF) - ((op2 >> 8) & 0xFF)));
  result += (uint32_t) abs((int32_t) (((op1 >> 16) & 0xFF) - ((op2 >> 16) & 0xFF)));
  result += (uint32_t) abs((int32_t) (((op1 >> 24) & 0xFF) - ((op2 >> 24) & 0xFF)));
  return result;
}

__STATIC_FORCEINLINE uint32_t __USADA8(uint32_t op1, uint32_t op2, uint32_t op3)
{
  op3 += (uint32_t) abs((int32_t) ((op1 & 0xFF) - (op2 & 0xFF)));
  op3 += (uint32_t) abs((int32_t) (((op1 >> 8) & 0xFF) - ((op2 >> 8) & 0xFF)));
  op3 += (uint32_t) abs((int32_t) (((op1 >> 16) & 0xFF) - ((op2 >> 16) & 0xFF)));
  op3 += (uint32_t) abs((int32_t) (((op1 >> 24) & 0xFF) - ((op2 >> 24) & 0xFF)));
  return op3;
}
